...
public interface IWWGraphQLEndpoint {
	...
	/**
	 * @return GraphResultContainer generated by a successful {@linkplain #executeRequest()}
	 */
	GraphResultContainer getResultContainer();

	/**
	 * @param resultContainer
	 *            GraphResultContainer generated by a successful {@linkplain #executeRequest()}. Should not need overloading, but just in case, this method is still exposed
	 */
	void setResultContainer(GraphResultContainer resultContainer);

	/**
	 * Runs the main code to execute the GraphQL request on Watson Work Services. {@linkplain #setRequest(GraphQLRequest)} must be called before calling this method. This method should not need
	 * overloading.
	 * 
	 * @throws WWException
